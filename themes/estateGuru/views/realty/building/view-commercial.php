...
<div class="object">
    <div class="object__title">
        ...
        <h2 class="caption">Офис <?= $data->city; ?></h2>
    </div>
    <div class="object__content">
        ...
        <div class="object__desc">
            ...
            <div class="object__desc-common">
                <?php if (!empty($data->whereObject)): ?>
                    <div class="row">
                        <div class="row__cell">Объект</div>
                        <div class="row__cell row__cell--right"><?= $data->whereObject; ?></div>
                    </div>
                <?php endif; ?>
            ...
            <div class="object__desc-common">
                <?php if (!empty($data->floorPos)): ?>
                    <div class="row">
                        <div class="row__cell">Этаж</div>
                        <div class="row__cell row__cell--right"><?= $data->floorPos; ?></div>
                    </div>
                <?php endif; ?>
