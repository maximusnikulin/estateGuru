...
$this->breadcrumbs = [
    ...
    Yii::t('SubscribeModule.subscribe', 'Редактирование'),
];

$this->pageTitle = Yii::t('SubscribeModule.subscribe', 'Подписки - редактирование');
...
<div class="page-header">
    <h1>
        <?=  Yii::t('SubscribeModule.subscribe', 'Редактирование') . ' ' . Yii::t('SubscribeModule.subscribe', 'Подписки'); ?>        <br/>
