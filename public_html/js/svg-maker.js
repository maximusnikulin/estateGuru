	    ...
	    new _vue2.default({
	        ...
	        methods: {
	            parsePath: function parsePath(path) {
	                ...
	                path = path.split("L").map(function (e) {
	                    return e.split(',');
	                });
	                console.log(path);
	                return path;
	            },
	            checkOnInitValues: function checkOnInitValues() {
	        ...
	        computed: {
	            ...
	            pathPoints: function pathPoints() {
	            ...
	            pointNext: function pointNext() {
	                return this.currentPos.map(function (el) {
	                    return el;
	                });
	            }
	        }
